...
import com.zbcn.module.batch.test.HelloItemProcessor;
import com.zbcn.module.batch.test.HelloLineAggregator;
import com.zbcn.module.batch.test.HelloLineMapper;
...
public class Main {
	...
	public static void main(String[] args) {
		String[] configs = new String[] { "resource/spring-batch.xml" };
		...
		flatFileItemReader.setResource(new FileSystemResource("file:src/resource/batch-data-source.csv"));
		...
		flatFileItemWriter.setResource(new FileSystemResource("file:src/resource/batch-data-source.csv"));
